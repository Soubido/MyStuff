...
namespace NewRhinoGold.Helpers
{
    public static class RhinoGoldHelper
    {
        public static bool TryGetGemData(RhinoObject obj, out Curve girdleCurve, out Plane gemPlane, out double gemSize)
        {
            ...
            //    FIX: Zuerst auf Geometry.UserData suchen (korrekte Position, OnTransform greift).
            //         Dann Fallback auf Attributes.UserData (Legacy, alte Dateien).
            ...
            // Fallback: Attributes (Legacy-Daten, OnTransform greift hier NICHT)
            if (smartData == null)
